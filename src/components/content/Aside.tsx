...
const Aside: Component<AsideProps> = (props) => {
  ...
  return (
    <aside class={`cn-aside ${type()}`} aria-label={title()}>
      <div class="title cn-artes" aria-hidden="true">
        <span class="icon">
          <svg
      ...
      <div class="content" innerHTML={props.content} />
    </aside>
  )
}
